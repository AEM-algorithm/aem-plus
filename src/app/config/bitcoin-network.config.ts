...
export const BITCOIN_DEFAULT_NODE_TEST_NET: ServerConfig =
  BITCOIN_NODES_TEST_NET[0];
...
export const BITCOIN_DEFAULT_NODE_MAIN_NET: ServerConfig =
  BITCOIN_NODES_MAIN_NET[0];
