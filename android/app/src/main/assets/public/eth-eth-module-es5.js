(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["eth-eth-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppWalletsEthEthPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppWalletsEthEthRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EthPageRoutingModule", function () {
        return EthPageRoutingModule;
      });
      /* harmony import */
      ...
      var _eth_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./eth.page */
      ...
      var EthPageRoutingModule = function EthPageRoutingModule() {
        _classCallCheck(this, EthPageRoutingModule);
      };

      EthPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function srcAppWalletsEthEthModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EthPageModule", function () {
      ...
      var _eth_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./eth-routing.module */
      "./src/app/wallets/eth/eth-routing.module.ts");
      /* harmony import */


      var _eth_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./eth.page */
      "./src/app/wallets/eth/eth.page.ts");
      /* harmony import */
      ...
      var _sharedComponents_chart_chart_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ../sharedComponents/chart/chart.component */
      "./src/app/wallets/sharedComponents/chart/chart.component.ts");
      /* harmony import */


      var _sharedComponents_transaction_list_transaction_list_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      ...
      var EthPageModule = function EthPageModule() {
        _classCallCheck(this, EthPageModule);
      };

      EthPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        declarations: [_eth_page__WEBPACK_IMPORTED_MODULE_6__["EthPage"], _sharedComponents_balance_balance_component__WEBPACK_IMPORTED_MODULE_7__["BalanceComponent"], _sharedComponents_chart_chart_component__WEBPACK_IMPORTED_MODULE_8__["ChartComponent"], _sharedComponents_transaction_list_transaction_list_component__WEBPACK_IMPORTED_MODULE_9__["TransactionListComponent"], _sharedComponents_transaction_item_transaction_item_component__WEBPACK_IMPORTED_MODULE_10__["TransactionItemComponent"], _sharedComponents_transaction_item_transaction_detail_transaction_detail_component__WEBPACK_IMPORTED_MODULE_11__["TransactionDetailComponent"]]
      })], EthPageModule);
      /***/
    },
    ...
    /***/
    function srcAppWalletsEthEthPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppWalletsEthEthPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EthPage", function () {
        return EthPage;
      });
      /* harmony import */
      ...
      var EthPage = /*#__PURE__*/function () {
        function EthPage(modalCtrl, route, walletsService) {
          _classCallCheck(this, EthPage);
        ...
        _createClass(EthPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.route.paramMap.subscribe(function (params) {
              _this.ethWallet = _this.walletsService.getWallet(params.get('id'));

              if (params.has('tokenId')) {
                _this.isTokenSelected = true;

                var ethToken = _this.walletsService.getToken(_this.ethWallet, params.get('tokenId'));

                _this.selectedEthToken = {
                  walletName: ethToken.name,
                  walletType: _this.ethWallet.walletType,
                  walletBalance: ethToken.balance,
                  walletAddress: _this.ethWallet.walletAddress
                }; //  no mock data for this view:

                _this.finalTrans = _this.walletsService.getTokenTransaction(_this.ethWallet, ethToken.id);
              } else {
                _this.isTokenSelected = false;
                _this.finalTrans = _this.ethWallet.transactions;
              }
            });
          }
        }, {
      ...
      EthPage.ctorParameters = function () {
        return [{
      ...
      EthPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-eth',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./eth.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/wallets/eth/eth.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./eth.page.scss */
        "./src/app/wallets/eth/eth.page.scss"))["default"]]
      })], EthPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=eth-eth-module-es5.js.map