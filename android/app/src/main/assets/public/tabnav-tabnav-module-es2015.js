...
const routes = [
    {
        ...
        children: [
            {
                path: 'wallets',
                loadChildren: () => Promise.all(/*! import() | wallets-wallets-module */[__webpack_require__.e("default~export-export-module~notifications-notifications-module~receive-receive-module~wallets-wallets-module"), __webpack_require__.e("default~detail-detail-module~wallets-wallets-module"), __webpack_require__.e("common"), __webpack_require__.e("wallets-wallets-module")]).then(__webpack_require__.bind(null, /*! ../wallets/wallets.module */ "./src/app/wallets/wallets.module.ts")).then((m) => m.WalletsPageModule),
            },
            {
                path: 'export',
                loadChildren: () => Promise.all(/*! import() | export-export-module */[__webpack_require__.e("default~export-export-module~notifications-notifications-module~receive-receive-module~wallets-wallets-module"), __webpack_require__.e("common"), __webpack_require__.e("export-export-module")]).then(__webpack_require__.bind(null, /*! ../export/export.module */ "./src/app/export/export.module.ts")).then((m) => m.ExportPageModule),
            },
            {
                path: 'swap',
                loadChildren: () => __webpack_require__.e(/*! import() | swap-swap-module */ "swap-swap-module").then(__webpack_require__.bind(null, /*! ../swap/swap.module */ "./src/app/swap/swap.module.ts")).then((m) => m.SwapPageModule),
            },
            {
                path: 'address-book',
                loadChildren: () => Promise.all(/*! import() | address-book-address-book-module */[__webpack_require__.e("common"), __webpack_require__.e("address-book-address-book-module")]).then(__webpack_require__.bind(null, /*! ../address-book/address-book.module */ "./src/app/address-book/address-book.module.ts")).then((m) => m.AddressBookPageModule),
            },
            {
                path: 'setting',
...
/* harmony import */ var _tabnav_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./tabnav-routing.module */ "./src/app/tabnav/tabnav-routing.module.ts");
/* harmony import */ var _tabnav_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./tabnav.page */ "./src/app/tabnav/tabnav.page.ts");
...
//# sourceMappingURL=tabnav-tabnav-module-es2015.js.map